        ...
        <main className="container mx-auto px-4 py-6 md:py-8 max-w-3xl">
          <div className="bg-card border rounded-lg p-6 md:p-8 mb-6">
            <div className="text-center mb-8">
              ...
              <p className="text-4xl md:text-6xl font-bold text-primary my-4">{score}%</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={handleRetry}
                className="flex-1 flex items-center justify-center gap-2 border px-4 py-2 md:py-3 rounded-md text-sm md:text-base font-medium hover:bg-muted transition-colors"
              >
          ...
          <div className="space-y-4 md:space-y-6">
            <h2 className="text-xl md:text-2xl font-bold">Review Your Answers</h2>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 md:py-8 max-w-3xl">
        <div className="bg-card border rounded-lg p-4 md:p-6">
          ...
          {/* Question */}
          <div className="mb-6">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6">{currentQuestion.question}</h2>
          ...
          <div className="flex justify-between pt-4 border-t">
            <button
              ...
              className="flex items-center gap-2 px-3 md:px-4 py-2 border rounded-md text-sm md:text-base font-medium hover:bg-muted transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Previous
            </button>
            ...
            {isLastQuestion ? (
              <button
                ...
                className="flex items-center gap-2 bg-primary text-primary-foreground px-4 md:px-6 py-2 rounded-md text-sm md:text-base font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Submit Quiz
        ...
        {/* Quick Navigation */}
        <div className="mt-6 bg-card border rounded-lg p-3 md:p-4">
          <p className="text-sm font-medium mb-3">Quick Navigation</p>
          <div className="grid grid-cols-8 sm:flex sm:flex-wrap gap-2">
