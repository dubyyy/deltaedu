      ...
      <main className="container mx-auto px-4 py-6 md:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 md:mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 md:px-6 py-2 md:py-3 rounded-md text-sm md:text-base font-medium hover:bg-primary/90 transition-colors w-full sm:w-auto"
          >
        ...
        {loading ? (
          ...
          <div className="bg-card border rounded-lg p-6 md:p-12 text-center">
            ...
            <Link
              href="/dashboard/notes/upload"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-4 md:px-6 py-2 md:py-3 rounded-md text-sm md:text-base font-medium hover:bg-primary/90 transition-colors"
            >
              <PlusCircle className="h-4 md:h-5 w-4 md:w-5" />
              ...
              >
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 text-center py-2 bg-primary text-primary-foreground rounded-md text-xs md:text-sm font-medium hover:bg-primary/90 transition-colors"
                  >
                    View
                  </Link>
                  <Link
